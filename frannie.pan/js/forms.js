...
const checkAnimalAddForm = () => {
   ...
   let ability = $("#animal-add-ability").val();
   let description = $("#animal-add-description").val();

   query({
      type:'insert_animal',
      params:[sessionStorage.userId,name,type,breed,ability,description]
   }).then(d=>{
      if(d.error) {
         throw d.error;
      }
...
const checkAnimalEditForm = () => {
   ...
   let ability = $("#animal-edit-ability").val();
   let description = $("#animal-edit-description").val();

   query({
      type:'update_animal',
      params:[name,type,breed,ability,description,sessionStorage.animalId]
   }).then(d=>{
      if(d.error) {
         throw d.error;
      }
